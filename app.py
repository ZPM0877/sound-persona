...
YOUR_APP_URL = "https://sound-persona-0877.streamlit.app/"
...
with st.expander("📊 4つの分析軸と全16タイプ（クリックで開く）"):
    ...
    | 記号 | 分析軸 | イメージ |
    |---|----|---|
    | **L(Lyric)** ↔ **S(Sound)** | **言葉** ↔ **響き** | 歌詞重視か、音の気持ちよさ重視か |
    | **E(Emotional)** ↔ **T(Technical)** | **直感** ↔ **技巧** | エモさ・衝動か、構成・テクニックか |
    | **M(Mainstream)**  ↔ **U(Underground)** | **王道** ↔ **個性** | みんなが知る曲か、知る人ぞ知る曲か |
    | **D(Dark) ↔ B(Bright)** | **内省** ↔ **発散** | 一人で浸りたいか、みんなで盛り上がりたいか |
    """)
